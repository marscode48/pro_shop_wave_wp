...
<div class="product-archive__header">
  ...
  ?>
    <h2>
      <span class="product-archive__header--top section__title fadeup"><?php woocommerce_page_title(); ?></span>
      <span class="product-archive__header--bottom section__text fadeup">
        <?php
        /**
