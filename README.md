...
本プロジェクトでは、**カスタムパーツ商品** と **アパレル・グッズ商品** で
...
カスタムパーツ商品は **形状・仕様差が少なく、順序管理が重要** なため、
「連番管理」を基本とします。
...
アパレル・グッズ商品は **カラー展開・着用画像・ディテール画像** が重要なため、
...
| 区分 | 管理方法 | 理由 |
| カスタムパーツ | 連番管理（01 / 02 / 03） | 形状差が少なく、順序が重要 |
| アパレル・グッズ（メイン） | カラー名 + main | バリエーション管理が必須 |
| アパレル・グッズ（ギャラリー共通） | 役割名（wear / detail / back） | 意味ベース管理が最適 |
